...
@flow(name="rpi_tutorial")
async def main(
    quantum_source: QuantumSource = "real-device",
    runtime_block_name: str = "ibm-runner",
    bitcounter_block_name: str = "rpi-tutorial",
    options_variable_name: str = "rpi-tutorial",
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description=(
            "Run tutorial-style BitCount flow on the RPI (AiMOS) Slurm cluster, "
            "with an optional HPC profile override."
        )
    )
    parser.add_argument(
        "--quantum-source",
    ...
    parser.add_argument("--bitcounter-block", default="rpi-tutorial")
    parser.add_argument("--options-variable", default="rpi-tutorial")
